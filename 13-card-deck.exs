...
defmodule DeckTest do
  ...
  test "deal" do
    ...
    {players, deck} =
      Deck.deal(deck, players, fn card, {name, cards} -> {name, cards ++ [card]} end)

    assert Enum.at(players, 0) ==
             {"tim",
              [
                {"Hearts", 2},
                {"Hearts", 6},
  ...
  test "deal 5 cards per player" do
    ...
    {players, deck} =
      Deck.deal(deck, players, fn card, {name, cards} -> {name, cards ++ [card]} end, 5)

    assert Enum.at(players, 0) ==
             {"tim",
              [{"Hearts", 2}, {"Hearts", 6}, {"Hearts", 10}, {"Hearts", "A"}, {"Clubs", 5}]}

    assert Enum.at(players, 1) ==
             {"jen", [{"Hearts", 3}, {"Hearts", 7}, {"Hearts", "J"}, {"Clubs", 2}, {"Clubs", 6}]}

    assert Enum.at(players, 2) ==
             {"mac", [{"Hearts", 4}, {"Hearts", 8}, {"Hearts", "Q"}, {"Clubs", 3}, {"Clubs", 7}]}

    assert Enum.at(players, 3) ==
             {"kai", [{"Hearts", 5}, {"Hearts", 9}, {"Hearts", "K"}, {"Clubs", 4}, {"Clubs", 8}]}
